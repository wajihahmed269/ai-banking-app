    ...
    try {
      if (DEMO_MODE) {
        window.setTimeout(() => {
          const user = { username };
          setCurrentUser(user);
          addToast({ type: 'success', title: authMode === 'signin' ? 'Signed in' : 'Account created', message: 'Prototype banking state is ready.' });
          enterDashboard(user);
